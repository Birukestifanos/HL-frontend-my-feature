...
import type { AdminTab, Tab, Admin, News, Emergency, Contact } from "../../types/admin";
...
// Modals
import { BeneficiaryModal } from "../../components/admin/modals/BeneficiaryModal";
import { NewsModal } from "../../components/admin/modals/NewsModal";
import { ContactDetailModal } from "../../components/admin/modals/ContactDetailModal";
import { TransparencyModal } from "../../components/admin/modals/TransparencyModal";
...
export function AdminPage() {
  ...
  const tabs: Tab[] = useMemo(
    () => [
      ...
      ...(isSuperAdmin
        ? [{ id: "admins" as AdminTab, label: "Admin Management", icon: Shield }]
        : []),
    ],
    [isSuperAdmin],
  );
      ...
      <BeneficiaryModal
        ...
        initialData={
          data.beneficiaryStats
            ? {
                total_beneficiaries:
                  data.beneficiaryStats.total_beneficiaries,
